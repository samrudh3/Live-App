              ...
              return Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var n = snapshot.data[index]['name'];
                    // var id = snapshot.data[index]['id'];
                    var ls = snapshot.data[index]['label_seller'];
                    var lb = snapshot.data[index]['label_buyer'];
                    var pu = snapshot.data[index]['price_unit'];
                    var s = snapshot.data[index]['slug'];
                    var i = snapshot.data[index]['icon'];
                    return Card(
